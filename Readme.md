...
# Parsing + Configuration Script – ioTracker3 - Rev. A

This **Parsing + Configuration** script is designed for the **ioTracker3** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ioTracker3 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ioTracker3** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
