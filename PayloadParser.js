function parseUplink(device, payload)
{
    ...
    env.log("Received data", data);
        ...
        var batterylevel = Math.round(data.batteryLevel / 2.54);
        var lat = data.gps.latitude;
        var lon = data.gps.longitude;
        var temp = data.temperature;
        var sos = data.uplinkReasonButton;
        ...
        if (lat != null && lon != null) {
            ...
            if (eplt != null)
            {
                eplt.updateLocationTrackerStatus(lat, lon);   
            }
        }
        ...
        if(batterylevel != null)
        {
            ...
            if (epbatt != null)
                epbatt.updateGenericSensorStatus(batterylevel);
        ...
        if(data.light != null)
        {
            ...
            if (eplight != null)
                eplight.updateGenericSensorStatus(data.light);
        ...
        */
        ...
        if(temp != null)
        {
            ...
            if (eptemp != null)
                eptemp.updateTemperatureSensorStatus(temp);
